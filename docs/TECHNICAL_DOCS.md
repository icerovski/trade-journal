...
Full syntax: `VALUE [F/T] [P:S/B/L] [R:x] [E:x] [TP:n] [C:TH/TE] [G:gap] [X:H/R/T] [SRC:name] [THM:theme]`
...
Menu option **9** renders a report over the decision journal (`trade_log`). It does not touch the trade flow.
