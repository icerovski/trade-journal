            ...
            with TabbedContent(initial="tab-visuals"):
                ...
                with TabPane("Exit Strategy", id="tab-exit"):
                    yield Static(
                        ...
                        "─────────┼─────────────────────┼─────────┼─────────────\n"
                        " [green]TREND[/]   │ ≥ 21                │ 15%     │ 20%\n"
                        " [white]NORMAL[/]  │ 10 – 20             │ 33%     │ 33% or close\n"
                        " [red]RANGING[/] │ < 10 or declining   │ 50%     │ Close all\n\n"

                        "[bold]What each regime means:[/]\n\n"
                        "  [bold green]TREND[/]\n"
                        "  The 200-DMA has been rising without interruption for at least a month.\n"
                        "  The position has genuine structural support. Trim conservatively to\n"
                        "  preserve the runway for the continuation.\n\n"
                        "  [bold white]NORMAL[/]\n"
                        "  The DMA is rising but hasn't yet achieved the 21-day confirmation.\n"
                        "  Trend structure is developing. Standard profit-taking applies.\n\n"
                        "  [bold red]RANGING[/]\n"
                        "  The DMA is declining or has barely moved in one direction. The position\n"
                        "  lacks structural support. Protect gains aggressively.\n\n"

                        "[bold]How the signal is calculated:[/]\n\n"
                        "  200-DMA Direction\n"
                        ...
                        "  DMA has moved in the same direction without reversal. At ≥ 21 days (≈ 1\n"
                        "  month of uninterrupted movement) the regime becomes TREND.\n\n"
